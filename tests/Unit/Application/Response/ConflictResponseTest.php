...
use Kartenmacherei\HttpFramework\Application\Response\ConflictResponse;
use Kartenmacherei\HttpFramework\UnitTest\Helper\CheckXdebugAvailableTrait;
use PHPUnit\Framework\MockObject\MockObject;
use PHPUnit\Framework\TestCase;

/**
 * @covers \Kartenmacherei\HttpFramework\Application\Response\ConflictResponse
 */
class ConflictResponseTest extends TestCase
{
    ...
    public function testSetsExpectedContentTypeHeader(): void
    {
        ...
        $response = new ConflictResponse($content);
        $response->send();
