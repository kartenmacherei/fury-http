...
use Kartenmacherei\HttpFramework\Application\Response\BadRequestResponse;
use Kartenmacherei\HttpFramework\UnitTest\Helper\CheckXdebugAvailableTrait;
use PHPUnit\Framework\MockObject\MockObject;
use PHPUnit\Framework\TestCase;

/**
 * @covers \Kartenmacherei\HttpFramework\Application\Response\BadRequestResponse
 */
class BadRequestResponseTest extends TestCase
{
    ...
    public function testSetsExpectedContentTypeHeader(): void
    {
        ...
        $response = new BadRequestResponse($content);
        $response->send();
